...
_KNOWN_CONNECTORS: dict[str, str] = {
    ...
    "cohere": "toolsconnector.connectors.cohere:Cohere",
    "confluence": "toolsconnector.connectors.confluence:Confluence",
    "contactout": "toolsconnector.connectors.contactout:ContactOut",
    ...
    "gemini": "toolsconnector.connectors.gemini:Gemini",
    ...
    "groq": "toolsconnector.connectors.groq:Groq",
    ...
    "huggingface": "toolsconnector.connectors.huggingface:HuggingFace",
    ...
    "lusha": "toolsconnector.connectors.lusha:Lusha",

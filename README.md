...
ToolsConnector gives you a single, typed Python interface to **79 connectors and 1,637 actions**. It works identically whether you're building a Django app, an OpenAI agent, or an MCP server for Claude Desktop.
...
- **79 connectors, 1,637 actions** across 20 categories -- communication, social, databases, DevOps, CRM, AI/ML, AWS infrastructure, and more
...
79 connectors, 1,637 actions across 20 categories.

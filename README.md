...
ToolsConnector gives you a single, typed Python interface to **73 connectors and 1,515 actions**. It works identically whether you're building a Django app, an OpenAI agent, or an MCP server for Claude Desktop.
...
- **73 connectors, 1,515 actions** across 20 categories -- communication, social, databases, DevOps, CRM, AI/ML, AWS infrastructure, and more
...
73 connectors, 1,515 actions across 20 categories.

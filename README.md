...
ToolsConnector gives you a single, typed Python interface to **77 connectors and 1,565 actions**. It works identically whether you're building a Django app, an OpenAI agent, or an MCP server for Claude Desktop.
...
- **77 connectors, 1,565 actions** across 20 categories -- communication, social, databases, DevOps, CRM, AI/ML, AWS infrastructure, and more
...
77 connectors, 1,565 actions across 20 categories.

...
TOOL_META: dict[str, dict] = {
    ...
    "odoo": {
        ...
        "logo": _BF("odoo.com"),
        "color": "#714B67",
        "tagline": "Read & write any Odoo model over JSON-RPC",
        "overview": "Odoo (formerly OpenERP) is a full ERP suite — CRM, Sales, Inventory, Accounting, HR, eCommerce, POS, Helpdesk, Manufacturing, and Projects. ToolsConnector talks to any Odoo model through its ORM over JSON-RPC, the catalog's first JSON-RPC connector. BYOK: bring your instance url, database, username, and an API key.",
        "use_cases": [
            "Sync contacts and CRM leads",
            "Create and confirm sales orders",
            "Manage inventory and product catalogs",
            "Pull invoices and accounting data",
            "Triage helpdesk tickets",
            "Read eCommerce and POS data",
        ],
        "auth_methods": ["API Key"],
        "rate_limit": "Instance-dependent (self/Odoo Online hosted)",
        "pricing": "Open-source Community edition free; Enterprise per-app/user pricing",
        "prerequisites": [
            "Odoo instance (self-hosted or Odoo Online)",
            "Database name and username",
            "API key generated from the user preferences page",
        ],
        "get_credentials_url": "https://www.odoo.com/documentation/19.0/developer/reference/external_api.html",
        "get_credentials_steps": "Odoo > top-right avatar > Preferences > Account Security > New API Key",
    },
    "jira": {
        "company": "Atlassian",
    ...
    "huggingface": {
        ...
        "logo": _BF("huggingface.co"),
        "color": "#FF9D00",
        "tagline": "Hosted model inference and Hub model/dataset search",
        "overview": "Hugging Face runs hosted model inference across the full task set via the Inference Providers router — text generation, chat completion, embeddings, summarization, translation, classification, NER, zero-shot, QA, table-QA, sentence similarity, and vision/audio tasks — and browses model, dataset, and Space metadata via the Hub API. The default `hf-inference` provider serves the traditional-ML tasks; heavier generative tasks route to partner providers (fal-ai, replicate, together) via the `provider` param. Bring your own user access token.",
        "use_cases": [
            "Run inference across thousands of open models",
            "Batch text embeddings for semantic search / RAG",
            "Zero-shot and fine-tuned text classification",
            "Chat completions via the OpenAI-compatible router",
            "Discover models, datasets, and Spaces on the Hub",
        ],
        "auth_methods": ["API Key (User Access Token)"],
        "pricing": "Free serverless tier (throttled) + pay-as-you-go Inference Providers",
        "rate_limit": "Varies by plan; free serverless inference is throttled",
        "prerequisites": ["Hugging Face account", "User access token (hf_...)"],
        "get_credentials_url": "https://huggingface.co/settings/tokens",
        "get_credentials_steps": "Settings > Access Tokens > New token (read scope is enough for inference + search)",
    },
    "gemini": {
        "company": "Google",
        ...
        "logo": _BF("gemini.google.com"),
        "color": "#1C69FF",
        "tagline": "Gemini models for text, vision, and embeddings",
        "overview": "The Google Gemini API provides access to Gemini models for multimodal generation (text, images, audio, video), token counting, embeddings, the Files API, context caching, and tuned models. The connector sends the API key via the `x-goog-api-key` header (never the URL). Use it for fast multimodal reasoning, long-context tasks, and embedding generation.",
        "use_cases": [
            "Multimodal generation (text, image, audio, video)",
            "Long-context document reasoning",
            "Text embeddings for search and RAG",
            "Context caching for repeated large prompts",
            "Token counting and cost estimation",
        ],
        "auth_methods": ["API Key"],
        "pricing": "Free tier + pay-as-you-go (varies by model)",
        "rate_limit": "Varies by model and tier",
        "prerequisites": ["Google account", "API key from Google AI Studio"],
        "get_credentials_url": "https://aistudio.google.com/app/apikey",
        "get_credentials_steps": "Google AI Studio > Get API key > Create API key",
    },
    "cohere": {
        "company": "Cohere",
        ...
        "logo": _BF("cohere.com"),
        "color": "#39594D",
        "tagline": "Enterprise LLMs, embeddings, and reranking",
        "overview": "The Cohere API provides chat (Command models), embeddings, the reranking endpoint for retrieval, classification, tokenization, embed-jobs, datasets, and fine-tuning. Cohere's rerank and embed models are widely used to power enterprise RAG pipelines and semantic search.",
        "use_cases": [
            "Retrieval reranking for RAG quality",
            "Embeddings for semantic search",
            "Enterprise chat with Command models",
            "Text classification",
            "Custom model fine-tuning",
        ],
        "auth_methods": ["API Key"],
        "pricing": "Free trial keys + pay-as-you-go production keys",
        "rate_limit": "Varies by endpoint and key type",
        "prerequisites": ["Cohere account", "API key from the dashboard"],
        "get_credentials_url": "https://dashboard.cohere.com/api-keys",
        "get_credentials_steps": "Dashboard > API Keys > create a Trial or Production key",
    },
    "mistral": {
        "company": "Mistral AI",
        ...
        "logo": _BF("mistral.ai"),
        "color": "#FA500F",
        "tagline": "Open-weight and frontier LLMs, OCR, and agents",
        "overview": "The Mistral API provides chat completions, embeddings, fill-in-the-middle (FIM) code completion, agents, moderations, classifiers, document OCR, model management, files, fine-tuning jobs, and batch jobs. It spans Mistral's open-weight and frontier models for both general and code-focused workloads.",
        "use_cases": [
            "Chat and reasoning with frontier models",
            "Code completion (FIM) and generation",
        ...
        "rate_limit": "Varies by model and tier",
        "prerequisites": ["Mistral account", "API key from La Plateforme console"],
        "get_credentials_url": "https://console.mistral.ai/api-keys/",
        "get_credentials_steps": "Console > API Keys > Create new key",
    },
    "groq": {
        "company": "Groq",
        ...
        "logo": _BF("groq.com"),
        "color": "#F55036",
        "tagline": "Ultra-fast LLM inference on the LPU",
        "overview": "The Groq API offers an OpenAI-compatible surface for ultra-low-latency chat completions, audio transcription/translation/speech, model listing, batches, and files — served on Groq's LPU inference hardware. Use it when response latency matters (real-time agents, voice, interactive UX).",
        "use_cases": [
            "Low-latency chat for real-time agents",
            "Fast audio transcription and translation",
            "Text-to-speech",
            "Batch inference jobs",
            "Drop-in OpenAI-compatible inference",
        ],
        "auth_methods": ["API Key"],
        "pricing": "Free tier + pay-as-you-go (varies by model)",
        "rate_limit": "Varies by model and tier",
        "prerequisites": ["Groq account", "API key from the console"],
        "get_credentials_url": "https://console.groq.com/keys",
        "get_credentials_steps": "Console > API Keys > Create API Key",
    },
    "salesforce": {
    ...
    "contactout": {
        ...
        "auth_methods": ["API Key (token header)"],
        "pricing": "Team/API plan (paid); credit-based across email/phone/search/verifier pools",
        "rate_limit": "People Search 60/min; free checkers 150/min; other 1000/min",
        "prerequisites": [
            "A ContactOut Team/API plan (the API is not on self-serve Email plans)",
            "API key from the ContactOut dashboard (sent as the `token` header, NOT Authorization)",
        ],
        "get_credentials_url": "https://contactout.com/api",
        "get_credentials_steps": "Contact ContactOut sales for a Team/API plan > get your API token from the dashboard > pass it as the `token` header",
    },
    "datadog": {
        "company": "Datadog Inc.",
    ...
    "lusha": {
        ...
        "auth_methods": ["API Key (api_key header)"],
        "pricing": "Paid plan; credit-based (email = 1, phone = 5), reported per call",
        "rate_limit": "25 req/s general; plan-based daily/hourly quotas (x-*-requests-left headers)",
        "prerequisites": [
            "A paid Lusha plan with API access",
            "API key from the Lusha dashboard (sent as the `api_key` header)",
            "V3 enabled on the account",
        ],
        "get_credentials_url": "https://dashboard.lusha.com",
        "get_credentials_steps": "Lusha dashboard > API settings > generate an API key > pass it as the `api_key` header (V3)",
    },
    "mailchimp": {
...
TOOL_REPOS: dict[str, list[dict[str, str]]] = {
    ...
    "huggingface": [
        {"url": "https://github.com/huggingface/huggingface_hub", "lang": "Python"},
        {"url": "https://github.com/huggingface/huggingface.js", "lang": "JavaScript"},
    ],
    "gemini": [
        {"url": "https://github.com/googleapis/python-genai", "lang": "Python"},
        {"url": "https://github.com/googleapis/js-genai", "lang": "JavaScript"},
    ],
    "cohere": [
        {"url": "https://github.com/cohere-ai/cohere-python", "lang": "Python"},
        {"url": "https://github.com/cohere-ai/cohere-typescript", "lang": "TypeScript"},
    ],
    "mistral": [
        {"url": "https://github.com/mistralai/client-python", "lang": "Python"},
        {"url": "https://github.com/mistralai/client-ts", "lang": "TypeScript"},
    ],
    "groq": [
        {"url": "https://github.com/groq/groq-python", "lang": "Python"},
        {"url": "https://github.com/groq/groq-typescript", "lang": "TypeScript"},
    ],
    "notion": [
